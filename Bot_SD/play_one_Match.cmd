...
python "%toolsPath%\playgame.py" %preViz% --engine_seed 42 --player_seed 42 --turntime=1000000 --end_wait=1.25 --verbose --log_dir game_logs --turns 1000 --map_file %Map% %bot1Path% %bot2Path% %bot3Path% %bot4Path% %postViz%
