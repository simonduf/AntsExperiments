...
python "%toolsPath%\playgame.py" %preViz% --engine_seed 42 --player_seed 42 --end_wait=11.25 --verbose --log_dir game_logs --turns 10000 --map_file %Map% %bot1Path% %bot2Path% %bot3Path% %bot4Path% %postViz%
